...
import { timeoutPerson } from '@/api/sludgeProperty';
...
export default {
  ...
  data() {
    return {
      ...
      imgUrlList: [
        require('@/assets/img/react1.png'),
        require('@/assets/img/react2.png'),
        require('@/assets/img/react3.png'),
        require('@/assets/img/react4.png'),
        require('@/assets/img/react4.png')
      ],
      data: [],
      isShow: false,
  ...
  methods: {
    async initData() {
      ...
      const { status, resultData } = await timeoutPerson(data);
