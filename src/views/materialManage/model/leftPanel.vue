 ...
 * @LastEditTime: 2024-08-21 14:24:43
 * @LastEditors: wangyr
 * @Description:
-->
<template>
...
import InWaterQuality from '../components/InWaterQuality.vue';
import MedicamentForecast from '../components/MedicamentForecast.vue';
export default {
  name: 'LeftPanel',
  components: {
    WaterStatistics,
