 ...
 * @LastEditors: wangyr
 * @LastEditTime: 2024-08-21 14:26:35
 * @Description:
-->
<template>
  <div :class="[showStage ? 'one' : 'oneOut', 'right_panel']">
    <power-analysis title="库存预警预测" :class="[showStage ? 'one' : 'oneOut', 'water-module']" />
    <medicine-analysis
      title="入库单状态"
...
export default {
  name: 'RightPanel',
  components: { PowerAnalysis, MedicineAnalysis, SludgeCount },
  props: {
    showStage: {
      type: Boolean,
      require: true
