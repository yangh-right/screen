...
(function () {
  ...
  e.prototype._buildCssText = function (g) {
    ...
    if (d.browser.ie < 7) {
      ...
      var i = '0 0';
      j instanceof BMapGL.Size && (i = j.width + 'px ' + j.height + 'px');
      m.push('background-position:' + i + ';');
    }
    if (n instanceof BMapGL.Size) {
      if (k instanceof BMapGL.Size) {
  ...
  e.prototype._bind = function () {
    ...
    function h(m, l) {
      ...
      if (m && l && j && o && k) {
        ...
        l.pixel = new BMapGL.Pixel(j - n.left, o - n.top);
